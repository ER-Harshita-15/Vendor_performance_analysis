...
def create_vendor_summary(conn):
    ...
    and adding new columns in the resultant data.
    """
    vendor_sale_summary=pd.read_sql_query("""WITH FreightSummary AS(
                                      SELECT 
                                          VendorNumber,
...
if __name__ == "__main__":
    ...
    logging.info("Creating vendor sale summary table")
    ...
    logging.info("Ingesting the data into database..........")
    ingest_db(clean_df, 'vendor_sale_summary', conn)
    logging.info("______Completed_____")
